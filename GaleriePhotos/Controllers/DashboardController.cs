...
namespace GaleriePhotos.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        [HttpGet("statistics")]
        public async Task<ActionResult<DashboardStatisticsViewModel>> GetStatistics()
        {
            // Find photos that have no GPS coordinates (both Latitude and Longitude are null or both are 0)
