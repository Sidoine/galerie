...
import { useMyApiClient } from "../stores/api-client"; // already local wrapper (no change placeholder)
...
const FaceNamePhotos = observer(function FaceNamePhotos() {
  ...
  const { galleryId, faceNameId } = route.params as {
    galleryId: number;
    faceNameId: number;
  };
    ...
    return (
      <View style={styles.centerContainer}>
        <Text style={styles.emptyText}>
          Aucune photo trouvée pour ce visage
        </Text>
      </View>
    );
  }
