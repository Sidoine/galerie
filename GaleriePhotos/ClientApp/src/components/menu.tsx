  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        style={[
          styles.menuItem,
          (route.name === "RootDirectory" || route.name === "Directory") &&
            styles.selected,
        ]}
        onPress={() =>
          navigation.navigate("RootDirectory", {
      ...
      <TouchableOpacity
        style={[styles.menuItem, route.name === "FaceNames" && styles.selected]}
        onPress={() =>
          navigation.navigate("FaceNames", {
            galleryId: directoriesStore.galleryId,
          })
        }
      >
          ...
          {settingsOpen && (
            <View style={styles.submenu}>
              ...
              <TouchableOpacity
                style={[
                  styles.submenuItem,
                  route.name === "DirectoryVisibilitySettings" &&
                    styles.selected,
                ]}
                onPress={() =>
                  navigation.navigate("DirectoryVisibilitySettings" as never)
                }
              >
