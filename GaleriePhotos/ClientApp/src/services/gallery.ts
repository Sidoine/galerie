...
export class GalleryController {
  ...
  create = (model: views.GalleryCreate) => {
    return this.client.fetchJson<views.Gallery>(
      "/api/galleries/",
      "POST",
  ...
  getSeafileApiKey = (id: number, request: views.SeafileApiKeyRequest) => {
    return this.client.fetchJson<views.SeafileApiKeyResponse>(
      `api/galleries/${id}/seafile/apikey`,
      "POST",
  ...
  getSeafileRepositories = (request: views.SeafileRepositoriesRequest) => {
    return this.client.fetchJson<views.SeafileRepositoriesResponse>(
      "api/galleries/seafile/repositories",
      "POST",
      JSON.stringify(request)
    );
  };
