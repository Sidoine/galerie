...
export const DirectoryBulkLocationModal = observer(
  function DirectoryBulkLocationModal({
    visible,
    photos: photoIds,
    onClose,
    ...
    const handleGeocode = async () => {
      ...
      try {
        ...
        const geocodeRequest: AddressGeocodeRequest = {
        ...
        if (response.ok && response.value) {
          ...
          if (
            ...
            Alert.alert(
              "Erreur",
              data.error || "Impossible de géolocaliser cette adresse"
            );
          }
        } else {
    ...
    const handleSave = async () => {
      ...
      try {
        ...
        const request: PhotoBulkUpdateLocation = {
        ...
        if (response.ok) {
          Alert.alert(
            "Succès",
            "La localisation de toutes les photos a été mise à jour"
          );
          onClose();
          // Reset form
          setAddress("");
            ...
            <View style={styles.inputSection}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  geocoding && styles.disabledButton,
                ]}
