...
namespace GaleriePhotos.Migrations
{
    ...
    [Migration("20260613111530_AddPhotoCollections")]
    partial class AddPhotoCollections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GaleriePhotos.Models.BackgroundServiceState", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                    ...
                    b.ToTable("BackgroundServiceStates");
                });
            ...
            modelBuilder.Entity("GaleriePhotos.Models.Face", b =>
                {
                    ...
                    b.Property<int?>("AutoNamedFromFaceId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AutoNamedFromFaceId");
            ...
            modelBuilder.Entity("GaleriePhotos.Models.PhotoCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("GalleryId", "UserId", "Name")
                        .IsUnique();

                    b.ToTable("PhotoCollections");
                });

            modelBuilder.Entity("GaleriePhotos.Models.PhotoCollectionPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PhotoCollectionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PhotoCollectionId", "PhotoId")
                        .IsUnique();

                    b.ToTable("PhotoCollectionPhotos");
                });
            ...
            modelBuilder.Entity("GaleriePhotos.Models.PhotoFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GaleriePhotos.Models.Place", b =>
                {
                    ...
                    b.HasIndex("GalleryId", "OsmPlaceId");

                    b.HasIndex("GalleryId", "OsmType", "OsmId");
            ...
            modelBuilder.Entity("GaleriePhotos.Models.Face", b =>
                {
                    b.HasOne("GaleriePhotos.Models.Face", "AutoNamedFromFace")
                        .WithMany()
                        .HasForeignKey("AutoNamedFromFaceId");
                    ...
                    b.Navigation("AutoNamedFromFace");
            ...
            modelBuilder.Entity("GaleriePhotos.Models.PhotoCollectionPhoto", b =>
                {
                    b.HasOne("GaleriePhotos.Models.PhotoCollection", "PhotoCollection")
                        .WithMany("Photos")
                        .HasForeignKey("PhotoCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PhotoCollection");
                });

            modelBuilder.Entity("GaleriePhotos.Models.PhotoDirectory", b =>
                {
                    b.HasOne("GaleriePhotos.Models.Photo", "CoverPhoto")
                        .WithMany()
