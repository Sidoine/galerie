...
namespace GaleriePhotos.Migrations
{
    ...
    [Migration("20251011201204_AddLastScannedDirectoryToGallery")]
    partial class AddLastScannedDirectoryToGallery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GaleriePhotos.Models.Gallery", b =>
                {
                    ...
                    b.Property<int?>("LastScannedDirectoryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LastScannedDirectoryId");
            ...
            modelBuilder.Entity("GaleriePhotos.Models.Gallery", b =>
                {
                    b.HasOne("GaleriePhotos.Models.PhotoDirectory", "LastScannedDirectory")
                        .WithMany()
                        .HasForeignKey("LastScannedDirectoryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("LastScannedDirectory");
                });
